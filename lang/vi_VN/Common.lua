...
CommonTranslationTable = {
	...
	["once_per_round"] = "Một lần trong mỗi vòng chơi",
	...
	["$DiscardCardWithSkill"] = "%from bỏ đi %card bởi [%arg]",
	["$DiscardCardByOther"] = "%from đã bỏ đi %card của %to",
	["$EnterDiscardPile"] = "%card chuyển vào chồng bài bỏ",
	["$MoveToDiscardPile"] = "%from chuyển %card vào chồng bài bỏ",
