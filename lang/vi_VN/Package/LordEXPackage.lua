...
return {
    ...
    ["duyu"] = "Đỗ Dự",
    ["wuku"] = "Vũ Khố",
    [":wuku"] = "Tỏa định kỹ: Khi 1 người thế lực xác định khác bạn sử dụng 1 trang bị, bạn tăng 1 [Võ Khố] (Tối đa 2).",
    ["miewu"] = "Diệt Ngô",
    [":miewu"] = "Một lần trong lượt của mỗi người, khi bạn cần sử dụng/đánh ra 1 lá cơ bản/công cụ, bạn có thể giảm 1 [Võ Khố] để chuyển hóa sử dụng/đánh ra 1 lá thành 1 lá cơ bản/công cụ đó, sau đó bạn rút 1 lá.",
    ["#armory"] = "Võ Khố",
	...
	["guishu"] = "Quỷ Thuật",
	[":guishu"] = "Bạn có thể chuyển hóa sử dụng 1 lá BÍCH trên tay thành [Tri Bỉ Tri Kỷ]/[Viễn Giao Cận Công]; Bạn cần sử dụng xen kẽ 2 lá trên theo cách này trong cùng 1 lượt." ,
	["yuanyu"] = "Viễn Vực",
    ...
    ["huaxiong"] = "Hoa Hùng",
    ["yaowu"] = "Diệu Võ",
    [":yaowu"] = "Hạn định kỹ: Sau khi bạn gây sát thương, nếu tướng này đang úp mặt, bạn có thể phát động kỹ năng này: Bạn tăng 2 giới hạn máu, hồi 2 máu; nếu làm vậy, sau khi bạn trận vong, tất cả người cùng thế lực với bạn mất 1 máu.",
    ["shiyong"] = "Thị Dũng",
    ...
    ["duannian"] = "Đoạn Niệm",
    [":duannian"] = "Khi kết thúc giai đoạn ra bài, nếu bạn có bài trên tay, bạn có thể bỏ tất cả bài trên tay, sau đó bổ xung bài đến giới hạn máu.",
    ["lianyou"] = "Liên Hựu",
    ...
    ["gongxiu"] = "Cộng Tu",
    [":gongxiu"] = "Giai đoạn rút bài, bạn có thể rút ít đi 1 lá, sau đó lựa chọn tối đa X người (X là giới hạn máu của bạn), lệnh họ:\n1. Rút 1 lá.\n2. Bỏ 1 lá.\nKhông thể liên tiếp lựa chọn cùng 1 mục.",
    ["jinghe"] = "Kinh Hợp",
    ...
    [":leiji_tianshu"] = "Khi bạn sử dụng/đánh ra [Thiểm], bạn có thể lệnh 1 người khác tiến hành phán xét, nếu kết quả phán xét là chất BÍCH, bạn gây 2 sát thương Lôi cho họ.",
    ["yinbing"] = "Âm Binh",
    ...
    ["yanzheng"] = "Ngôn Chính",
    [":yanzheng"] = "Khi bắt đầu giai đoạn chuẩn bị, nếu số bài trên tay bạn nhiều hơn 1, bạn có thể giữ lại 1 lá và bỏ đi số lá còn lại và chọn tối đa X người (X là số lá đã bỏ), bạn gây 1 sát thương cho họ.",
    ...
    [":zhuangrong"] = "Một lần trong giai đoạn ra bài, bạn có thể bỏ 1 lá công cụ, bạn nhận kỹ năng \"Vô Song\" đến hết giai đoạn này.",
    ...
    ["zhuihuan"] = "Truy Hoàn",
    [":zhuihuan"] = "\n• Khi kết thúc lượt, bạn có thể chọn tối đa 2 người, lệnh mỗi người nhận 1 [Truy Hoàn] khác nhau đến khi bắt đầu lượt tiếp theo của bạn (Không ai được biết loại [Truy Hoàn] đã nhận); Sau khi họ nhận sát thương, họ bỏ đi [Truy Hoàn]; sau đó, nếu [Truy Hoàn] đã bỏ là:\n• \"Sát thương\": Họ gây 1 sát thương cho nguồn sát thương;\n• \"Bỏ bài\": Nguồn sát thương bỏ 2 lá trên tay.",
	...
	["liangfan"] = "Lượng Phản",
	[":liangfan"] = "Tỏa định kỹ: Khi bắt đầu giai đoạn chuẩn bị, nếu bạn có [Hàm], bạn mất 1 máu, sau đó thu lấy tất cả [Hàm]; Trong lượt này, sau khi bạn gây sát thương cho 1 người do sử dụng [Hàm], bạn có thể thu lấy 1 lá của họ.",
	["letter"] = "Hàm",
    ...
    ["paiyi"] = "Bài Dị",
    [":paiyi"] = "Một lần trong giai đoạn ra bài, có thể đưa 1 [Quyền] vào chồng bài bỏ và chọn 1 người, họ rút X lá (X là số [Quyền] bạn có, tối đa 7); sau đó nếu số bài trên tay họ > bạn, bạn gây 1 sát thương cho họ.",
    ...
    ["chenglve"] = "Thành Lược",
    [":chenglve"] = "Sau khi kết toán bài do 1 người cùng thế lực với bạn sử dụng, nếu số mục tiêu > 1, bạn có thể lệnh họ rút 1 lá; sau đó nếu bạn đã nhận sát thương từ lá này, bạn có thể lệnh 1 người cùng thế lực với bạn không có tướng úp và không có tiêu ký nào nhận được 1 tiêu ký [Âm Dương Ngư].",
    ["shicai"] = "Thị Tài",
    ...
    ["panjun"] = "Phan Tuấn",
    ["congcha"] = "Quan Vy",
    [":congcha"] = "\n• Khi bắt đầu giai đoạn chuẩn bị, bạn có thể chọn 1 người không có thế lực; Cho đến khi bắt đầu lượt tiếp theo của bạn, khi họ mở tướng và trở thành có thế lực, nếu họ cùng thế lực với bạn, bạn và họ rút 2 lá; nếu không, họ mất 1 máu.\n• Giai đoạn rút bài, nếu không có người không có thế lực, bạn có thể lệnh số lá rút +2.",
    ["gongqing"] = "Công Thanh",
    ...
    ["huaiyi"] = "Hoài Dị",
    [":huaiyi"] = "\n• Một lần trong giai đoạn ra bài, bạn có thể mở toàn bộ bài trên tay, nếu có đủ 2 màu, bạn thực hiện lần lượt:\n- Bạn chọn 1 màu và bỏ những lá trên tay có màu này;- Bạn chọn tối đa X người có bài, thu lấy 1 lá của họ (X là số lá bạn vừa bỏ), nếu lá được thu lấy là trang bị thì đặt lá đó lên tướng này thay vì thu lấy, gọi là [Dị].\n• Bạn có thể sử dụng hoặc đánh ra [Dị] như bài trên tay.",
    ["zisui"] = "Tứ Tuy",
    [":zisui"] = "Tỏa định kỹ:\n• Giai đoạn rút bài, nếu có [Dị], bạn rút thêm X lá (X là số [Dị]).\n• Khi bắt đầu giai đoạn kết thúc, nếu số [Dị] lớn hơn giới hạn máu của bạn, bạn trận vong.",
