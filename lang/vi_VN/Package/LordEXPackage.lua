...
return {
	...
	["liaohua"] = "Liêu Hóa",
	["dangxian"] = "Đương Tiên",
	[":dangxian"] = "Tỏa định kỹ, sau khi lật tướng lần đầu tiên, bạn nhận 1 tiêu ký [Tiên Khu]. Sau khi bắt đầu lượt chơi, bạn nhận 1 giai đoạn ra bài",
	...
	["hongyuan"] = "Hoằng Viện",
	[":hongyuan"] = "Khi bạn rút bài vì hiệu quả của \"Hợp Tung\", bạn có thể lệnh 1 người khác cùng thế lực rút bài thay bạn. Một lần trong giai đoạn ra bài, bạn có thể mở 1 lá trên tay, lá đó khi ở trên tay bạn trong giai đoạn này xem như có ký hiệu \"Hợp Tung\".",
	["mingzhe"] = "Minh Triết",
    ...
    ["zhaofu"] = "Chiêu Phụ",
    [":zhaofu"] = "Đầu giai đoạn ra bài, nếu tổng số [Thưởng] của tất cả người chơi nhỏ hơn 3, bạn có thể bỏ 1 lá và chọn 1 người khác, người đó nhận 1 tiêu ký [Thưởng]. Sau khi lá cơ bản/công cụ phổ thông do người có [Thưởng] sử dụng kết toán xong, bạn có thể lệnh người đó bỏ 1 tiêu ký [Thưởng], xem như bạn sử dụng lá đó.",
    ...
    ["guohuai"] = "Quách Hoài",
    ["jingce"] = "Tinh Sách",
    [":jingce"] = "Giai đoạn ra bài, sau khi bạn sử dụng lá thứ X kết toán xong (X là máu hiện tại của bạn), nếu không có ai đang giải quyết hấp hối, bạn có thể lệnh 1 người khác thế lực chấp hành 1 [Quân Lệnh], nếu họ không chấp hành, bạn rút 2 lá.",
    ...
    ["chendao"] = "Trần Đáo",
    ["wanglie"] = "Vãng Liệt",
    [":wanglie"] = "Lá đầu tiên bạn sử dụng trong giai đoạn ra bài không hạn chế khoảng cách. Giai đoạn ra bài, khi bạn sử dụng [Sát] hoặc công cụ phổ thông, bạn có thể lệnh cho tất cả người chơi không được hưởng ứng với lá này; nếu làm vậy, bạn không thể sử dụng bài trong giai đoạn này.",
	["dizai"] = "Địa Tải",
    ...
    ["jiansu"] = "Kiệm Tố",
    [":jiansu"] = "Phó tướng kỹ, Giảm 0.5 máu gốc. Khi bạn nhận bài ngoài lượt, bạn có thể mở những lá này trên tay bạn, gọi là [Kim] chừng nào lá đó còn trên tay bạn; Những người chơi khác luôn nhìn thấy [Kim]. Đầu giai đoạn ra bài, bạn có thể bỏ đi tùy ý lá [Kim], sau đó chọn 1 người đã bị thương có số máu không lớn hơn số [Kim] đã bỏ, lệnh họ hồi 1 máu.",
    ...
    ["maliang"] = "Mã Lương",
    ["mumeng"] = "Mục Minh",
    [":mumeng"] = "Một lần trong giai đoạn ra bài, bạn có thể sử dụng 1 lá Cơ trên tay như [Viễn Giao Cận Công] hoặc [Lục Lực Đồng Tâm]",
    ["naman"] = "Nạp Man",
	...
	["lifu"] = "Lễ Phụ",
	[":lifu"] = "Một lần trong giai đoạn ra bài, bạn có thể chọn 1 người, lệnh họ bỏ 2 lá, sau đó bạn xem lá trên cùng của chồng bài rút và giao cho họ.",
	["yanzhong"] = "Ngôn Trung",
	...
	["jinwu"] = "Căng Võ",
	[":jinwu"] = "Đầu giai đoạn ra bài, bạn có thể lệnh bạn chấp hành 1 quân lệnh, nếu chấp hành, bạn xem như sử dụng 1 [Sát]; nếu không chấp hành, bạn kết thúc giai đoạn ra bài.",
	["zhuke"] = "Trúc Khoa",
    ...
    ["zhouyi"] = "Chu Di",
    ["zhukou"] = "Trục Khấu",
    [":zhukou"] = "Trong lượt của mỗi người chơi, sau khi bạn gây sát thương lần đầu tiên trong giai đoạn ra bài của họ, bạn có thể rút X lá (X là số lá bạn đã sử dụng trong lượt này, tối đa 5).",
    ["duannian"] = "Đoạn Niệm",
    [":duannian"] = "Kết thúc giai đoạn ra bài, nếu bạn có bài trên tay, có thể bỏ đi tất cả bài trên tay, sau đó bổ xung bài đến giới hạn máu.",
    ["lianyou"] = "Liên Hựu",
    ...
    ["xianshou"] = "Tiên Thụ",
    [":xianshou"] = "Một lần trong giai đoạn ra bài, bạn có thể chọn 1 người, lệnh họ rút 1 lá; Nếu họ không bị thương, họ rút thêm 1 lá.",
    ["lundao"] = "Luận Đạo",
    ...
    ["guowu"] = "Quắc Vũ",
    [":guowu"] = "Đầu giai đoạn ra bài, bạn có thể mở tất cả bài trên tay, căn cứ vào số loại bài bạn có mà bạn nhận hiệu quả tương ứng:\n  1+: Bạn thu lấy 1 lá [Sát] từ chồng bài bỏ.\n  2+: Trong giai đoạn này, bạn sử dụng bài không hạn chế khoảng cách.\n  3: Một lần trong giai đoạn này, sau khi bạn chỉ định mục tiêu cho [Sát], bạn có thể chỉ định thêm tối đa 2 mục tiêu.",
    ["zhuangrong"] = "Trang Nhung",
    [":zhuangrong"] = "Một lần trong giai đoạn ra bài, bạn có thể bỏ 1 lá công cụ, thu lấy kỹ năng \"Vô Song\" đến hết giai đoạn này.",
	...
	["liuqi"] = "Lưu Kỳ",
	["wenji"] = "Vấn Kế",
	[":wenji"] = "Đầu giai đoạn ra bài, bạn có thể lệnh 1 người khác giao cho bạn 1 lá ngửa mặt. Nếu họ cùng thế lực hoặc vô thế lực, lượt này bạn sử dụng lá này không hạn chế khoảng cách cùng số lần và không thể hưởng ứng; Nếu họ không cùng thế lực, bạn giao cho họ 1 lá bài khác.",
	
	["tunjiang"] = "Truân Giang",
	[":tunjiang"] = "Giai đoạn kết thúc, nếu bạn trong giai đoạn ra bài sử dụng ít nhất 1 lá và không chỉ định người khác làm mục tiêu, bạn có thể rút X lá (X là số thế lực trên bàn chơi).",
    ...
    ["paiyi"] = "Bài Dị",
    [":paiyi"] = "Một lần trong giai đoạn ra bài, có thể đưa 1 [Quyền] vào chồng bài bỏ và chọn 1 người, họ rút X lá (X là số [Quyền] bạn có, tối đa 7); sau đó nếu số bài trên tay họ lớn hơn bạn, bạn gây 1 sát thương cho họ.",
    ...
    ["dongzhao"] = "Đổng Chiêu",
    ["quanjin"] = "Khuyến Tiến",
    [":quanjin"] = "Một lần trong giai đoạn ra bài, bạn có thể giao 1 lá trên tay cho người từng nhận sát thương trong giai đoạn này và lệnh họ chấp hành 1 [Quân Lệnh]. Nếu họ chấp hành, bạn rút 1 lá; nếu không chấp hành và bạn không phải người có nhiều bài trên tay nhất, bạn bổ xung bài trên tay đến khi bằng người có nhiều bài trên tay nhất, tối đa 5 lá.",
    ["zaoyun"] = "Tạc Vận",
    [":zaoyun"] = "Một lần trong giai đoạn ra bài, có thể chọn 1 người không cùng thế lực với bạn và khoảng cách từ bạn đến họ lớn hơn 1 và bỏ X lá bài trên tay (X là khoảng cách từ bạn đến họ -1), khoảng cách từ bạn đến họ là 1 cho đến hết lượt, bạn gây 1 sát thương cho họ.",
    ...
    ["wujing"] = "Ngô Cảnh",
    ["diaogui"] = "Điều Quy",
    [":diaogui"] = "Một lần trong giai đoạn ra bài, có thể sử dụng 1 lá trang bị như [Điệu Hổ Ly Sơn]; Sau đó, nếu bằng cách này thế lực của bạn có sự thay đổi về đội hình, bạn rút X lá (X là số người của đội hình đông nhất trong những quan hệ đội hình ở thế lực của bạn có sự thay đổi).",
    ...
    ["zhidao"] = "Trĩ Đạo",
    [":zhidao"] = "Tỏa định kỹ, đầu giai đoạn ra bài, bạn chọn 1 người khác; trong lượt này, khoảng cách từ bạn đến họ là 1, bạn không thể chọn người ngoài bạn và họ làm mục tiêu của bài; sau khi bạn gây sát thương cho họ lần đầu tiên trong giai đoạn này, bạn thu lấy 1 lá trong vùng chơi của họ.",
    ["jilix"] = "Ký Li",
    ...
    ["xiahouba"] = "Hạ Hầu Bá",
    ["baolie"] = "Báo Liệt",
    [":baolie"] = "Tỏa định kỹ, Đầu giai đoạn ra bài, lệnh những người không cùng thế lực có tầm đánh đến bạn sử dụng [Sát] với bạn, nếu không bạn bỏ 1 lá của họ; Bạn sử dụng [Sát] với người có máu không ít hơn bạn không giới hạn tầm đánh và số lần.",
    ...
    ["duwu"] = "Độc Võ",
    [":duwu"] = "Hạn định kỹ, giai đoạn ra bài, bạn có thể chọn tất cả người khác thế lực trong tầm đánh và lựa chọn [Quân Lệnh], họ lần lượt chọn có chấp hành [Quân Lệnh] hay không, nếu không chấp hành, bạn gây 1 sát thương cho họ và rút một lá; sau khi 1 người thoát khỏi trạng thái hấp hối do nhận sát thương từ kỹ năng này, bạn mất 1 máu.",
	...
	["pengyang"] = "Bành Dạng",
	["daming"] = "Đạt Mệnh",
	[":daming"] = "Đầu giai đoạn ra bài của người cùng thế lực, bạn có thể bỏ 1 công cụ, bạn đưa 1 người đang không trong trạng thái liên hoàn vào trạng thái liên hoàn, bạn rút X lá (X là số người trong trạng thái liên hoàn), chọn:\n1. Sử dụng [Đào] với người đang có lượt; 2. Người đang có lượt sử dụng [Sát Lôi] với người do bạn chọn.",
	["xiaoni"] = "Hiêu Nghịch",
    ...
    ["tongling"] = "Thông Linh",
    [":tongling"] = "Một lần trong giai đoạn ra bài, sau khi bạn gây sát thương cho 1 người không cùng thế lực (A), bạn có thể chọn 1 người cùng thế lực (B), B có thể sử dụng 1 lá với A; nếu lá này gấy sát thương, bạn và B rút 2 lá; nếu không gây sát thương, bạn lệnh A thu lấy lá bạn đã sử dụng để gây sát thương.",
    ["jinxian"] = "Cận Hãm",
	...
	["qingyin"] = "Quy Ẩn",
	[":qingyin"] = "Hạn định kỹ, giai đoạn ra bài, bạn chọn tất cả người cùng thế lực (Áp dụng sau khi bạn đã mở tướng này), lần lượt hồi máu đến tối đa; sau đó bạn loại bỏ tướng này.",
