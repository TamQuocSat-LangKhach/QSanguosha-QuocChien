...
return {
	...
	["zhendu"] = "Độc Tửu",
	[":zhendu"] = "Đầu giai đoạn ra bài của người chơi khác, có thể bỏ 1 lá bài trên tay, xem như họ sử dụng 1 [Tửu], sau đó bạn gây cho họ 1 sát thương.",
	...
	["jizhao"] = "Kích Chiếu",
	[":jizhao"] = "Hạn định kỹ: Khi ban trong trạng thái hấp hối, bạn có thể bổ sung bài trên tay đến giới hạn máu, hồi máu đến 2, mất \"Thụ Việt\" và nhận \"Nhân Đức\"",
	["@jizhao"] = "Kích Chiếu",
