...
return {
	...
	["jixi"] = "Cấp Tập",
	[":jixi"] = "Chủ tướng kỹ, Giảm 0.5 máu gốc: Bạn có thể chuyển hóa sử dụng [Điền] -> [Thuận Thủ Khiên Dương].",
	["ziliang"] = "Tư Lương",
	...
	["jiangwei"] = "Khương Duy",
	["tiaoxin"] = "Khiêu Hấn",
	[":tiaoxin"] = "Giai đoạn ra bài chủ động 1 lần: Bạn có thể lệnh 1 người có tầm đánh tới bạn chọn 1 mục:\n1. Họ sử dụng [Sát] với bạn;\n2. Lệnh bạn bỏ 1 lá của họ.",
	...
	[":shangyi"] = "Giai đoạn ra bài chủ động 1 lần: Bạn có thể lệnh cho 1 người khác xem bài trên tay của bạn, sau đó bạn lựa chọn 1 mục:\n1. Bạn xem bài trên tay họ và bỏ 1 lá màu Đen trong đó.\n2. Bạn xem tất cả tướng ẩn của họ.",
