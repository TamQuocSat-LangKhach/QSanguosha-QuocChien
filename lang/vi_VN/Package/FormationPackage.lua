...
return {
	...
	["jiangwei"] = "Khương Duy",
	["tiaoxin"] = "Khiêu Hấn",
	[":tiaoxin"] = "Một lần trong giai đoạn hành động, bạn có thể lệnh 1 người có tầm đánh tới bạn sử dụng [Sát] lên bạn, nếu không, bạn bỏ 1 lá của họ.",
	["@tiaoxin-slash"] = "%src đã phát động \"Khiêu Hấn\", hãy sử dụng [Sát] lên %src",
	["yizhi"] = "Di Chí",
	[":yizhi"] = "Phó tướng kỹ, Giảm 0.5 máu gốc: Nếu Chủ tướng của bạn có kỹ năng \"Quan Tinh\" thì số lá được xem luôn là 5; nếu không, bạn nhận kỹ năng \"Quan Tinh\".",
	["tianfu"] = "Thiên Phúc",
	...
	["&jiangwanfeiyi"] = "Tưởng Uyển Phí Y",
	["shengxi"] = "Sinh Tức",
	[":shengxi"] = "Giai đoạn kết thúc, nếu trong lượt này bạn không gây sát thương, bạn có thể rút 2 lá.",
	["shoucheng"] = "Thủ Thành",
	[":shoucheng"] = "Sau khi người chơi cùng thế lực mất đi lá bài cuối cùng trên tay ngoài lượt, bạn có thể lệnh họ rút 1 lá.",
	["@shoucheng"] = "Có thể phát động \"Thủ Thành\", lệnh cho 1 người rút 1 lá.",

	["#jiangqin"] = "Kỳ Hề Chi Khí",
	["jiangqin"] = "Tưởng Khâm",
	["shangyi"] = "Thượng Nghĩa",
	[":shangyi"] = "Một lần trong giai đoạn hành động, bạn có thể lệnh cho 1 người khác xem bài trên tay của bạn, sau đó bạn lựa chọn 1 mục:\n1. Bạn xem bài trên tay họ và bỏ 1 lá màu đen trong đó.\n2. Bạn xem tất cả tướng ẩn của họ.",
