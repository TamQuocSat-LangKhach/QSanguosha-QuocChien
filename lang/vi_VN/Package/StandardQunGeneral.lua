...
return {
	...
	["lijian"] = "Ly Gián",
	[":lijian"] = "Một lần trong giai đoạn ra bài, bạn có thể bỏ 1 lá và lựa chọn 2 người khác có giới tính nam, người chọn sau xem như sử dụng [Quyết Đấu] với người chọn trước.",
	["biyue"] = "Bế Nguyệt",
	...
	[":shuangxiong"] = "Giai đoạn rút bài, bạn có thể chọn không rút bài; nếu làm vậy, bạn tiến hành phán xét, sau đó thu lấy kết quả phán xét;\n‣ Trong lượt này, bạn có thể chuyển hóa sử dụng bài trên tay không cùng màu với kết quả phán xét trên thành [Quyết Đấu].",
	...
	["guidao"] = "Quỷ Đạo",
	[":guidao"] = "Khi phán xét của 1 người có hiệu lực, bạn có thể đánh ra 1 lá Đen để hoán đổi với kết quả phán xét đó.",
