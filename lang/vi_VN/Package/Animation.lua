return {
	...
	["molu"] = "殁颅",
	[":molu"] = "主将技，当你处于濒死状态时，若你有副将，你可以将体力回复至体力上限，然后移除你的副将。",
	["$MoluAnimate"] = "学姐有头不科学！",
	...
	["miaolv"] = "妙律",
	[":miaolv"] = "出牌阶段，你可以弃置任意数量的手牌，然后体力值等于你弃置的牌数的角色各回复1点体力。",
	...
	["yinren"] = "音刃",
	[":yinren"] = "准备阶段或结束阶段开始时，你可以弃置一张手牌，然后展示所有手牌，若这些牌的花色均不同，你指定一名其他角色，视为对其使用一张【杀】。",
	["@yinren-slash"] = "请指定“音刃”的【杀】的目标角色。",
	["@yinren-invoke"] = "你可以弃置一张手牌，发动“音刃”",
