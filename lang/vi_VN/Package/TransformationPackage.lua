...
return {
	...
	["xunyou"] = "Tuân Du",
	["qice"] = "Kỳ sách",
	[":qice"] = "Giai đoạn ra bài chủ động 1 lần: Bạn có thể chuyển hóa sử dụng tất cả bài trên tay -> Công cụ phổ thông tùy ý (Số mục tiêu không vượt quá số lá đem chuyển hóa);\n▷ Bạn có thể đổi Phó tướng.",
	["zhiyu"] = "Trí Ngu",
	...
	["sanyao"] = "Tán Dao",
	[":sanyao"] = "Giai đoạn ra bài chủ động 1 lần: Bạn có thể bỏ 1 lá và chọn 1 người nhiều máu nhất, bạn gây 1 sát thương cho họ.",
	["zhiman"] = "Chế Man",
	...
	["yongjin"] = "Dũng Tiến",
	[":yongjin"] = "Hạn định kỹ: Giai đoạn ra bài chủ động: Tối đa 3 lần, bạn có thể di chuyển 1 trang bị trên bàn chơi.",
	["@brave"] = "Dũng Tiến",
	...
	["flame_map"] = "Phong Hỏa",
	[":flamemap"] = "• Giai đoạn ra bài của mỗi người thế lực Ngô chủ động 1 lần: Họ có thể đặt 1 trang bị lên »Duyên Giang Phong Hỏa Đồ«, gọi là [Phong Hỏa].\n• Khi bắt đầu giai đoạn chuẩn bị của người thế lực Ngô, họ có thể nhận 1 kỹ năng tùy theo số [Phong Hỏa]:\n* 1+: »Anh Tư«;\n* 2+: »Hảo Thi«;\n* 3+: »Thiệp Liệp«;\n* 4+: »Độ Thế«;\n▷ Nếu có 5 [Phong Hỏa] trở lên, họ có thể nhận thêm 1 kỹ năng khác.\n• Tỏa định kỹ: Sau khi bạn nhận sát thương từ lá bài, đưa 1 [Phong Hỏa] vào chồng bài bỏ.",
