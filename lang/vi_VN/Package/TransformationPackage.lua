...
return {
	...
	["xunyou"] = "Tuân Du",
	["qice"] = "Kỳ sách",
	[":qice"] = "Một lần trong giai đoạn hành động, có thể sử dụng tất cả bài trên tay như 1 lá công cụ phổ thông (Số mục tiêu không vượt quá số lá bài trên tay), sau đó bạn có thể đổi Phó tướng",
	["zhiyu"] = "Trí Ngu",
	...
	["wanwei"] = "Văn Ngụy",
	[":wanwei"] = "Khi bài của bạn bị người khác chỉ định do bị lấy hoặc bỏ đi, có thể đổi thành bạn tự chọn lá của bạn.",
	["@wanwei-dismantle"] = "Văn Ngụy: Hãy chọn %arg lá bài để %src bỏ đi",
	["@wanwei-extraction"] = "Văn Ngụy: Hãy chọn %arg lá bài để %src thu lấy",
	["yuejian"] = "Ước Kiệm",
	[":yuejian"] = "Tỏa định kỹ, đầu giai đoạn bỏ bài của người cùng thế lực, nếu lượt này họ không sử dụng bài chọn người khác thế lực làm mục tiêu, giới hạn trữ bài của họ trở thành giới hạn máu",
	...
	["diaodu"] = "Điều Độ",
	["#diaodu-draw"] = "Điều Độ",
	[":diaodu"] = "Khi 1 người cùng thế lực sử dụng trang bị, họ có thể rút 1 lá. Đầu giai đoạn hành động, có thể thu lấy 1 lá trong vùng trang bị của 1 người cùng thế lực, nếu lá đó là của bạn, bạn giao lá đó cho 1 người khác; nếu không, bạn có thể giao lá đó cho 1 người khác ngoài họ.",
	...
	["diancai"] = "Điển Tài",
	[":diancai"] = "Khi kết thúc giai đoạn hành động của người khác, nếu bạn đã mất ít nhất X lá trong giai đoạn này (X là số máu của bạn và tối thiểu 1), bạn có thể bổ sung bài trên tay tới giới hạn máu; Nếu làm vậy, bạn có thể đổi Phó tướng.",
