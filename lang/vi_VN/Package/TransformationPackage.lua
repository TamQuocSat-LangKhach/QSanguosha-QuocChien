...
return {
	...
	["xunyou"] = "Tuân Du",
	["qice"] = "Kỳ sách",
	[":qice"] = "Một lần trong giai đoạn ra bài, bạn có thể chuyển hóa sử dụng tất cả bài trên tay thành 1 lá công cụ phổ thông (Số mục tiêu không vượt quá số lá đem sử dụng), sau đó bạn có thể đổi Phó tướng.",
	["zhiyu"] = "Trí Ngu",
	...
	["yongjin"] = "Dũng Tiến",
	[":yongjin"] = "Hạn định kỹ: Giai đoạn ra bài, bạn có thể di chuyển 1 trang bị trên bàn chơi; sau đó, bạn có thể lặp lại quá trình này thêm 2 lần.",
	["@brave"] = "Dũng Tiến",
