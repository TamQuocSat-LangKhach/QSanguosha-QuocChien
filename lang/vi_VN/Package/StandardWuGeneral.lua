...
return {
	...
	["sunquan"] = "Tôn Quyền",
	["zhiheng"] = "Chế Hành",
	[":zhiheng"] = "Một lần trong giai đoạn ra bài, bạn có thể bỏ tối đa X lá (X là giới hạn máu của bạn), sau đó bạn rút số lá tương ứng.",
	...
	["huanggai"] = "Hoàng Cái",
	["kurou"] = "Khổ Nhục",
	[":kurou"] = "Một lần trong giai đoạn ra bài, bạn có thể bỏ 1 lá; Nếu làm vậy bạn mất 1 máu, sau đó rút 3 lá, giới hạn sử dụng [Sát] của bạn trong giai đoạn này +1.",
	...
	["fanjian"] = "Phản Gián",
	[":fanjian"] = "Một lần trong giai đoạn ra bài, bạn có thể mở ra 1 lá bài trên tay và giao cho 1 người khác, bạn lệnh cho họ lựa chọn 1 mục: 1. Họ mở ra tất cả bài trên tay và bỏ đi tất cả lá của họ có cùng chất với lá bạn đã mở ra;\n2. Họ mất 1 máu.",
	...
	[":yinghun"] = "Khi bắt đầu giai đoạn chuẩn bị, bạn có thể lựa chọn 1 người khác và bạn lựa chọn 1 mục: 1. Lệnh họ rút X lá sau đó bỏ đi 1 lá; 2. Lệnh họ rút 1 lá sau đó bỏ đi X lá (X là số máu bạn đã mất).",
	...
	["lusu"] = "Lỗ Túc",
	["haoshi"] = "Hảo Thi",
	[":haoshi"] = "Giai đoạn rút bài, bạn có thể rút thêm 2 lá; nếu làm vậy, sau khi bạn rút bài, nếu số bài trên tay bạn > 5, bạn giao một nửa bài trên tay (làm tròn xuống) cho 1 người khác có số bài trên tay ít nhất.",
	["#haoshi-give"] = "Hảo Thi: Giao bài",
	["@haoshi-give"] = "Hảo Thi: Chọn %arg lá trên tay và giao cho 1 người có ít bài nhất.",
	["dimeng"] = "Kết Minh",
	[":dimeng"] = "Một lần trong giai đoạn ra bài, bạn có thể chọn 2 người khác và bỏ đi X lá (X là số bài chênh lệch trên tay giữa 2 người), sau đó lệnh họ hoán đổi bài trên tay.",
	...
	["dingfeng"] = "Đinh Phụng",
	["duanbing"] = "Đoản Binh",
	[":duanbing"] = "Sau khi bạn chỉ định mục tiêu cho [Sát], bạn có thể lệnh 1 người ở khoảng cách 1 của bạn trở thành mục tiêu của [Sát] này",
	["duanbing-invoke"] = "\"Đoản Binh\": Có thể chọn 1 người trong tầm 1 để trở thành mục tiêu của [Sát]",
	["fenxun"] = "Phấn Tấn",
	[":fenxun"] = "Một lần trong giai đoạn ra bài, bạn có thể bỏ 1 lá và lựa chọn 1 người khác, khoảng cách từ bạn đến họ là 1 đến sau khi kết thúc lượt này.",
