...
return {
	...
	["sunquan"] = "Tôn Quyền",
	["zhiheng"] = "Chế Hành",
	[":zhiheng"] = "Giai đoạn ra bài chủ động 1 lần: Bạn có thể bỏ tối đa X lá (X là giới hạn máu của bạn), bạn rút số lá tương ứng.",

	["#ganning"] = "Cẩm Phàm Du Hiệp",
	["ganning"] = "Cam Ninh",
	["qixi"] = "Kỳ Tập",
	[":qixi"] = "Giai đoạn ra bài chủ động: Bạn có thể chuyển hóa sử dụng lá Đen -> [Quá Hạ Sách Kiều].",
	...
	["huanggai"] = "Hoàng Cái",
	["kurou"] = "Khổ Nhục",
	[":kurou"] = "Giai đoạn ra bài chủ động 1 lần: Bạn có thể bỏ 1 lá, thực hiện lần lượt:\n- Bạn mất 1 máu;\n- Bạn rút 3 lá;\n- Giới hạn sử dụng [Sát] của bạn trong giai đoạn này +1.",
	...
	["daqiao"] = "Đại Kiều",
	["guose"] = "Quốc Sắc",
	[":guose"] = "Giai đoạn ra bài chủ động: Bạn có thể chuyển hóa sử dụng lá RÔ -> [Lạc Bất Tư Thục]",
	["liuli"] = "Lưu Ly",
	...
	["duoshi"] = "Độ Thế",
	[":duoshi"] = "Giai đoạn ra bài chủ động 4 lần: Bạn có thể chuyển hóa sử dụng bài Đỏ trên tay -> [Dĩ Dật Đãi Lao].",

	["#sunshangxiang"] = "Cung Yêu Cơ",
	["sunshangxiang"] = "Tôn Thượng Hương",
	["jieyin"] = "Kết Nhân",
	[":jieyin"] = "Giai đoạn ra bài chủ động 1 lần: Bạn có thể bỏ 2 lá trên tay và chọn 1 người khác có giới tính nam đang bị thương, bạn và họ hồi 1 máu.",
	["xiaoji"] = "Kiêu Cơ",
	...
	["dimeng"] = "Kết Minh",
	[":dimeng"] = "Giai đoạn ra bài chủ động 1 lần: Bạn có thể chọn 2 người khác và bỏ đi X lá (X là số bài chênh lệch trên tay giữa 2 người), lệnh họ hoán đổi bài trên tay.",
	...
	["&erzhang"] = "Trương Chiêu Trương Hoành",
	["zhijian"] = "Trực Gián",
	[":zhijian"] = "Giai đoạn ra bài chủ động: Bạn có thể đặt 1 trang bị trên tay vào vùng trang bị trống tương ứng của người khác, sau đó bạn rút 1 lá.",
	["guzheng"] = "Cổ Chính",
	[":guzheng"] = "Khi kết thúc giai đoạn bỏ bài của người khác, bạn có thể giao cho họ 1 lá trong những lá họ đã bỏ trong giai đoạn này;\n▷ Bạn có thể thu lấy tất cả lá đã bị bỏ đi trong giai đoạn này.",
	...
	["fenxun"] = "Phấn Tấn",
	[":fenxun"] = "Giai đoạn ra bài chủ động 1 lần: Bạn có thể bỏ 1 lá và lựa chọn 1 người khác, khoảng cách từ bạn đến họ là 1 trong lượt này.",
