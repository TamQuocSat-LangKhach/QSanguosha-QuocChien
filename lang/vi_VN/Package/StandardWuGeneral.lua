...
return {
	...
	[":xiaoji"] = "Khi bạn mất đi bài trong vùng trang bị, bạn có thể:\nNếu đang là lượt của bạn, rút 1 lá;\nNếu không phải lượt của bạn, rút 3 lá.",

	["#sunjian"] = "Vũ Liệt Đế",
	["sunjian"] = "Tôn Kiên",
	["yinghun_sunjian"] = "Anh Hồn",
	[":yinghun"] = "Giai đoạn chuẩn bị, bạn có thể lựa chọn một người chơi khác và bạn lựa chọn một mục: 1. Lệnh họ rút X lá sau đó bỏ đi 1 lá; 2. Lệnh họ rút 1 lá sau đó bỏ đi X lá (X là số máu bạn đã mất).",
	...
	["xiaoqiao"] = "Tiểu Kiều",
	["hongyan"] = "Hồng Nhan",
	[":hongyan"] = "Toả định kỹ, lá Bích của bạn và kết quả phán xét Bích của bạn xem như Cơ; Nếu bạn có lá Cơ trong vùng trang bị, giới hạn trữ bài của bạn +1",
	["tianxiang"] = "Thiên Hương",
	[":tianxiang"] = "Hai lần trong lượt của mỗi người, khi bạn nhận sát thương, có thể bỏ một lá Cơ trên tay để chặn sát thương này lại và lựa chọn một người khác, bạn chọn 1 mục mà chưa chọn trong lượt này:\n1. Lệnh họ nhận một điểm sát thương từ nguồn sau đó rút X thẻ bài (X là số máu đã mất của họ, tối đa 5);\n2. Lệnh họ mất một sinh lực sau đó thu lấy bài bạn vừa bỏ.",
	...
	["&erzhang"] = "Trương Chiêu Trương Hoành",
	["zhijian"] = "Trực Gián",
	[":zhijian"] = "Giai đoạn hành động, có thể đặt 1 trang bị trên tay vào vùng trang bị của người khác, sau đó rút 1 lá.",
	["guzheng"] = "Cổ Chính",
