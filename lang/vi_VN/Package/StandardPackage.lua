...
local t = {
	...
	["analeptic"] = "Tửu",
	[":analeptic"] = "Bài cơ bản\n\nCách thức I: \nSử dụng: Trong giai đoạn hành động, 1 lần trong lượt.\nMục tiêu: Bản thân.\nHiệu quả: Trong lượt này khi sử dụng 1 lá [Sát] tiếp theo sẽ tăng 1 sát thương."
	...
	[":DoubleSword"] = "Bài trang bị - Vũ khí\n\nTầm đánh: 2\nKỹ năng: Sau khi xác định từng mục tiêu của [Sát], nếu mục tiêu khác giới tính với bạn, bạn có thể lệnh mục tiêu chọn bỏ 1 lá bài trên tay hoặc để bạn rút 1 lá bài.",
	...
	["Axe"] = "Quán Thạch Phủ",
	[":Axe"] = "Bài trang bị - Vũ khí\n\nTầm đánh: 3\nKỹ năng: Sau khi mục tiêu bị tấn công sử dụng lá[Thiểm] có hiệu lực, có thể bỏ 2 lá bài để vô hiệu hoá lá [Thiểm] đó.",
	["@Axe"] = "Bạn có thể bỏ ra 2 lá bài để [Sát] vẫn có hiệu lực.",
	["~Axe"] = "Chọn 2 lá bài muốn bỏ rồi bấm \"Xác nhận\"",
	...
	["KylinBow:dhorse"] = "Chiến mã +1",
	["KylinBow:ohorse"] = "Chiến mã -1",
	...
	[":Fan"] = "Bài trang bị - Vũ khí\n\nTầm đánh: 4\nKỹ năng: Khi bạn sử dụng [Sát] phổ thông, bạn có thể biến lá [Sát] này thành [Sát Hỏa].",
	["fan"] = "Chu Tước Vũ Phiến",
...
"\nHiệu quả: Nếu mục tiêu không dùng [Sát] lên người chơi được chỉ định, bạn lấy vũ khí của mục tiêu.",
	...
	[":nullification"] = "Bài công cụ\n\nSử dụng: Khi có lá công cụ phát động hiệu quả lên một người chơi.\nMục tiêu: Lá công cụ.\nHiệu quả: Vô hiệu hiệu quả của lá công cụ với người chơi đó. Nếu công cụ đó là [Thiểm Điện], lá [Thiểm Điện] chuyển sang mục tiêu tiếp theo.",

	["heg_nullification"] = "Vô Giải Khả Kích - Quốc",
	[":heg_nullification"] = "Bài công cụ\n\nSử dụng: Khi có lá công cụ phát động hiệu quả lên một người chơi.\nMục tiêu: Lá công cụ.\nHiệu quả: Vô hiệu hiệu quả của lá công cụ với người chơi đó hoặc toàn bộ người cùng thế lực với người chơi đó. Nếu công cụ đó là [Thiểm Điện], lá [Thiểm Điện] chuyển sang mục tiêu tiếp theo.",
	...
	[":indulgence"] = "Bài công cụ thời gian\n\nSử dụng: Trong giai đoạn hành động.\nMục tiêu: Một người chơi khác.\nHiệu quả: Giai đoạn phán xét của mục tiêu, tiến hành phán xét, nếu kết quả phán xét không phải chất Cơ, bỏ qua giai đoạn hành động. Sau đó bỏ lá này.",

	["lightning"] = "Thiểm Điện",
	[":lightning"] = "Bài công cụ thời gian\n\nSử dụng: Trong giai đoạn hành động.\nMục tiêu: Bản thân.\nHiệu quả: Giai đoạn phán xét của mục tiêu, tiến hành phán xét, nếu kết quả phán xét từ 2~9 Bích, mục tiêu nhận 3 điểm sát thương Lôi, sau đó bỏ lá này. Nếu không, lá [Thiểm Điện] chuyển sang mục tiêu tiếp theo.",
	...
	[":fire_attack"] = "Bài công cụ\n\nSử dụng: Trong giai đoạn hành động.\nMục tiêu: Một người chơi có bài trên tay.\nHiệu quả: Mục tiêu đưa ra một lá bài, bạn có thể bỏ 1 lá cùng chất trên tay để gây cho mục tiêu 1 sát thương Hoả.",
	...
	[":supply_shortage"] = "Bài công cụ thời gian\n\nSử dụng: Trong giai đoạn hành động.\nMục tiêu: Một người chơi khác trong tầm 1 của bạn.\nHiệu quả: Giai đoạn phán xét của mục tiêu, tiến hành phán xét, nếu kết quả phán xét không phải là Tép sẽ bỏ qua lượt rút bài. Sau đó bỏ lá này.",
