...
return {
	...
	["dianwei"] = "Điển Vi",
	["qiangxi"] = "Cường Kích",
	[":qiangxi"] = "Giai đoạn ra bài chủ động 1 lần: Bạn có thể chọn 1 người khác, bạn chọn bỏ 1 Vũ khí hoặc mất 1 máu, bạn gây 1 sát thương cho họ.",

	["#xunyu"] = "Vương Tá Chi Tài",
	["xunyu"] = "Tuân Úc",
	["quhu"] = "Vờn Hổ",
	[":quhu"] = "Giai đoạn ra bài chủ động 1 lần: Bạn có thể tiến hành đấu điểm với 1 người có số máu > bạn:\n* Nếu bạn thắng: Họ gây 1 sát thương cho 1 người trong tầm đánh của họ do bạn chỉ định;\n* Nếu bạn không thắng: Họ gây 1 sát thương cho bạn.",
