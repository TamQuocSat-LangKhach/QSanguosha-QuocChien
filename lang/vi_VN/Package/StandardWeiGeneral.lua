...
return {
	...
	["caocao"] = "Tào Tháo",
	["jianxiong"] = "Gian Hùng",
	[":jianxiong"] = "Sau khi bạn nhận sát thương, bạn có thể thu lấy lá bài gây sát thương cho bạn.",
	...
	["ganglie"] = "Cương Liệt",
	[":ganglie"] = "Sau khi bạn nhận sát thương, bạn có thể tiến hành phán xét, nếu kết quả phán xét là:\nĐỏ: bạn gây 1 sát thương cho nguồn sát thương;\nĐen: bạn bỏ 1 lá của nguồn sát thương",
	...
	["xuchu"] = "Hứa Chử",
	["luoyi"] = "Lỏa Y",
	[":luoyi"] = "Khi kết thúc giai đoạn rút bài, bạn có thể bỏ 1 lá; nếu làm vậy, trong lượt này, khi bạn gây sát thương cho mục tiêu của [Sát] hoặc [Quyết Đấu], sát thương này +1.",
	...
	["zhenji"] = "Chân Cơ",
	["luoshen"] = "Lạc Thần",
	[":luoshen"] = "Giai đoạn chuẩn bị, bạn có thể tiến hành phán Xét, nếu kết quả phán xét có màu Đen, bạn có thể lặp lại quá trình này; Sau đó bạn thu lấy tất cả kết quả phán xét có màu Đen.",
	...
	["shensu"] = "Thần Tốc",
	[":shensu"] = "Bạn có thể chọn tùy ý các mục sau:\n1. Bỏ qua giai đoạn phán xét và giai đoạn rút bài;\n2. Bỏ qua giai đoạn hành động và bỏ 1 trang bị;\n3. Bỏ qua giai đoạn bỏ bài và mất 1 máu;\nVới mỗi mục bạn chọn, xem như bạn sử dụng [Sát] không hạn chế khoảng cách.",
	...
	["zhanghe"] = "Trương Cáp",
	["qiaobian"] = "Xảo Biến",
	[":qiaobian"] = "Bạn có thể bỏ 1 lá bài trên tay để bỏ qua 1 giai đoạn trong lượt (ngoại trừ chuẩn bị và kết thúc); nếu giai đoạn đã bỏ qua là:\n* Giai đoạn rút bài: Bạn có thể chọn tối đa 2 người có bài trên tay, bạn thu lấy 1 lá trên tay mỗi người;\nGiai đoạn hành động: Bạn có thể di chuyển 1 lá trên bàn chơi.",
	...
	[":duanliang"] = "Bạn có thể chuyển hóa sử dụng lá Đen không phải Công cụ thành [Binh Lương Thốn Đoạn] không giới hạn khoảng cách; Nếu khoảng cách giữa bạn và mục tiêu > 2, vô hiệu kỹ năng này trong giai đoạn này.",

	["#caoren"] = "Đại Tướng Quân",
	["caoren"] = "Tào Nhân",
	["jushou"] = "Chiếm Thủ",
	[":jushou"] = "Giai đoạn kết thúc, bạn có thể rút X lá (X là số thế lực còn sống), sau đó bỏ 1 lá trên tay; nếu lá bị bỏ là trang bị, xem như bạn sử dụng; nếu bạn rút > 2 lá, bạn thay đổi trạng thái chồng tướng.",
	...
	["dianwei"] = "Điển Vi",
	["qiangxi"] = "Cường Kích",
	[":qiangxi"] = "Một lần trong giai đoạn hành động, bạn có thể chọn 1 người khác, bạn chọn bỏ 1 Vũ khí hoặc mất 1 máu, sau đó bạn gây 1 sát thương cho họ.",

	["#xunyu"] = "Vương Tá Chi Tài",
	["xunyu"] = "Tuân Úc",
	["quhu"] = "Vờn Hổ",
	[":quhu"] = "Một lần trong giai đoạn hành động, bạn có thể tiến hành đấu điểm với 1 người có số máu > bạn;\n* Nếu bạn thắng, họ gây 1 sát thương cho 1 người trong tầm đánh của họ do bạn chỉ định;\n* Nếu bạn không thắng, họ gây 1 sát thương cho bạn.",
	...
	["yuejin"] = "Nhạc Tiến",
	["xiaoguo"] = "Dũng Mãnh",
	[":xiaoguo"] = "Giai đoạn kết thúc của 1 người khác, bạn có thể bỏ 1 lá cơ bản, lệnh họ chọn 1 mục:\n1. Họ bỏ 1 trang bị và lệnh bạn rút 1 lá.\n2. Bạn gây 1 sát thương cho họ.",
