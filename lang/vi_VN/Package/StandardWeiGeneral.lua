...
return {
	...
	["ganglie"] = "Cương Liệt",
	[":ganglie"] = "Sau khi nhận sát thương, có thể tiến hành phán xét. Nếu kết quả phán xét là:\nĐỏ: gây 1 sát thương cho nguồn sát thương;\nĐen: bỏ 1 lá bài của nguồn sát thương",
	...
	["caoren"] = "Tào Nhân",
	["jushou"] = "Chiếm Thủ",
	[":jushou"] = "Giai đoạn kết thúc, có thể rút X lá (X là số thế lực còn sống); sau đó bỏ 1 lá trên tay, nếu lá được bỏ đi là trang bị, xem như sử dụng. Nếu bạn rút nhiều hơn 2 lá bài, đặt chồng tướng.",
	...
	["dianwei"] = "Điển Vi",
	["qiangxi"] = "Cường Kích",
	[":qiangxi"] = "Một lần trong giai đoạn hành động, bạn có thể chọn 1 người chơi khác, chọn bỏ 1 Vũ khí hoặc mất 1 máu, bạn gây 1 sát thương cho họ.",
	...
	["yuejin"] = "Nhạc Tiến",
	["xiaoguo"] = "Dũng Mãnh",
	[":xiaoguo"] = "Giai đoạn kết thúc của một người khác, có thể bỏ 1 lá cơ bản để lệnh người đó chọn:\n1. Bỏ 1 trang bị và lệnh bạn rút 1 lá.\n2. Nhận 1 sát thương từ bạn.",
