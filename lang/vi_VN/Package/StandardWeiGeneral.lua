...
return {
	...
	["ganglie"] = "Cương Liệt",
	[":ganglie"] = "Sau khi bạn nhận sát thương, bạn có thể tiến hành phán xét, nếu màu của kết quả phán xét là:\n- Đỏ: Bạn gây 1 sát thương cho nguồn sát thương;\n- Đen: bạn bỏ 1 lá của nguồn sát thương",
	...
	["zhenji"] = "Chân Cơ",
	["luoshen"] = "Lạc Thần",
	[":luoshen"] = "Khi bắt đầu giai đoạn chuẩn bị, bạn có thể tiến hành phán Xét, nếu kết quả phán xét có màu Đen, bạn có thể lặp lại quá trình này; sau đó bạn thu lấy tất cả kết quả phán xét có màu Đen.",
	...
	["caoren"] = "Tào Nhân",
	["jushou"] = "Chiếm Thủ",
	[":jushou"] = "Khi bắt đầu giai đoạn kết thúc, bạn có thể rút X lá (X là số thế lực còn sống), sau đó:\n- Bạn bỏ 1 lá trên tay; nếu lá bị bỏ là trang bị, xem như bạn sử dụng thay vì bỏ;\n- Nếu bạn rút > 2 lá, bạn thay đổi trạng thái chồng tướng.",
