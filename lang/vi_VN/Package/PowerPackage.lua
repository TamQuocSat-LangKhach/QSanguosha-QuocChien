...
return {
	...
	[":fengying"] = "Hạn định kỹ: Giai đoạn ra bài chủ động: Bạn có thể chuyển hóa sử dụng tất cả bài trên tay -> [Hiệp Thiên Tử Dĩ Lệnh Chư Hầu] (Bỏ qua yêu cầu Đại thế lực);\n▶ Khi bạn sử dụng [Hiệp Thiên Tử Dĩ Lệnh Chư Hầu] này, bạn lệnh tất cả người cùng thế lực với bổ sung bài trên tay đến giới hạn máu.",
	...
	["xuanhuo"] = "Huyễn Hoặc",
	[":xuanhuo"] = "Giai đoạn ra bài của người khác có cùng thế lực với bạn chủ động 1 lần: Họ có thể giao cho bạn 1 lá trên tay, sau đó họ có thể bỏ 1 lá và lựa chọn nhận 1 trong các kỹ năng sau mà chưa có trên bàn cho đến hết lượt hoặc tướng có kỹ năng tương ứng được mở: »Võ Thánh«, »Bào Hao«, »Long Đảm«, »Thiết Kỵ«, »Liệt Cung«, »Cuồng Cốt«.",
	...
	["ganlu"] = "Cam Lộ",
	[":ganlu"] = "Giai đoạn ra bài chủ động 1 lần: Bạn có thể chọn 2 người có số bài trong vùng trang bị không cùng bằng 0 và số chênh lệch ≤ số máu bạn đã mất, hoán đổi bài trong vùng trang bị của 2 người này.",
	...
	["weidi"] = "Ngụy Đế",
	[":weidi"] = "Giai đoạn ra bài chủ động 1 lần: Bạn có thể chọn 1 người khác đã nhận bài từ chồng bài rút trong lượt này, yêu cầu họ chấp hành 1 [Quân Lệnh], nếu họ không chấp hành, bạn thu lấy toàn bộ bài trên tay họ, sau đó giao cho họ lượng bài tương đương.",
	...
	["huibian"] = "Huy Tiên",
	[":huibian"] = "Giai đoạn ra bài chủ động 1 lần: Bạn có thể chọn 1 người thế lực Ngụy và 1 người thế lực Ngụy khác đang bị thương, thực hiện lần lượt:\n- Bạn gây 1 sát thương cho người đầu tiên và họ rút 2 lá;\n- Lệnh người còn lại hồi 1 máu.",
	["zongyu"] = "Tổng Ngự",
