...
return {
	...
	["jianglve"] = "Tướng Lược",
	[":jianglve"] = "Hạn định kỹ, Giai đoạn hành động, bạn có thể chọn 1 [Quân Lệnh], sau đó người khác có cùng thế lực với bạn có thể chấp hành [Quân Lệnh] này; Bạn và những người đã chọn chấp hành [Quân Lệnh] tăng 1 giới hạn máu, hồi 1 máu, sau đó bạn rút X lá bài (X là số người đã hồi máu)",
	...
	["xuanhuo"] = "Huyễn Hoặc",
	[":xuanhuo"] = "Một lần trong giai đoạn hành động của người khác có cùng thế lực với bạn, họ có thể giao cho bạn 1 lá trên tay, sau đó họ có thể bỏ 1 lá và lựa chọn nhận 1 trong các kỹ năng sau mà chưa có trên bàn cho đến hết lượt hoặc tướng có kỹ năng tương ứng được mở: \"Võ Thánh\", \"Bào Hao\", \"Long Đảm\", \"Thiết Kỵ\", \"Liệt Cung\", \"Cuồng Cốt\".",
	...
	["ganlu"] = "Cam Lộ",
	[":ganlu"] = "Một lần trong giai đoạn hành động, bạn có thể chọn 2 người có số bài trong vùng trang bị không cùng bằng 0 và số chênh lệch ≤ số máu bạn đã mất, hoán đổi bài trong vùng trang bị của 2 người này.",
	...
	["weidi"] = "Ngụy Đế",
	[":weidi"] = "Một lần trong giai đoạn hành động, bạn có thể chọn 1 người khác đã nhận bài từ chồng bài rút trong lượt này, yêu cầu họ chấp hành 1 [Quân Lệnh]; Nếu họ không chấp hành, bạn thu lấy toàn bộ bài trên tay họ xong giao cho họ lượng bài tương đương.",
