...
return {
	...
	["fudi"] = "Phụ Địch",
	[":fudi"] = "Sau khi bạn nhận sát thương, bạn có thể giao cho nguồn sát thương 1 lá bài trên tay, sau đó gây 1 sát thương cho 1 người cùng thế lực với nguồn sát thương mà có số máu nhiều nhất trong thế lực đó và ≥ bạn.",
	["congjian"] = "Tòng Gián",
