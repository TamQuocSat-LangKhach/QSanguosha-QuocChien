...
return {
	...
	["yongjue"] = "Dũng Quyết",
	[":yongjue"] = "Sau khi kết toán xong [Sát] do người cùng thế lực với bạn sử dụng trong giai đoạn ra bài, nếu lá này là lá đầu tiên họ sử dụng trong giai đoạn này, bạn có thể lệnh họ thu lấy lá [Sát] này.",
