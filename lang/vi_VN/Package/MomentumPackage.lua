...
return {
	...
	["hunshang"] = "Hồn Thương",
	[":hunshang"] = "Phó tướng kỹ, Giảm 0.5 máu gốc: Khi bắt đầu giai đoạn chuẩn bị, nếu máu của bạn là 1, trong lượt này, bạn có kỹ năng »Anh Tư« và »Anh Hồn«.",
	["yingzi_sunce"] = "Anh Tư",
	...
	["fengshi"] = "Phong Thỉ",
	[":fengshi"] = "Trận pháp kỹ: Quan hệ vây công: nếu bạn là người vây công, sau khi người vây công xác định mục tiêu của lá [Sát], ứng với mỗi mục tiêu, nếu mục tiêu này là người bị vây công, lệnh họ bỏ 1 lá trong vùng trang bị.",
