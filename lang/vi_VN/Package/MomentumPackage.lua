...
return {
	...
	[":hengjiang"] = "Sau khi nhận 1 sát thương, có thể làm người chơi đang trong này giảm 1 giới hạn trữ bài. Cuối lượt, nếu ở giai đoạn bỏ bài, họ không bỏ lá nào, bạn rút X lá bài (X là số lần bạn đã phát động \"Hoành Giang\" trong lượt này).",
	["@hengjiang"] = "Hoành Giang",
	...
	["sunce"] = "Tôn Sách",
	["jiang"] = "Hùng Dũng",
	[":jiang"] = "Sau khi bạn xác định hoặc trở thành mục tiêu của lá [Sát] Đỏ hoặc [Quyết đấu], bạn có thể rút 1 lá bài.",
	["yingyang"] = "Ưng Dương",
	...
	["&chenwudongxi"] = "Trấn Vũ Đổng Tập",
	["duanxie"] = "Đoạn Tiết",
	[":duanxie"] = "Một lần trong giai đoạn hành động, có thể đưa X người không trong trạng thái xích vào trạng thái xích (X là số máu đã mất của bạn), sau đó đưa bạn vào trạng thái xích.",
	["fenming"] = "Phấn Mệnh",
	[":fenming"] = "Giai đoạn kết thúc, nếu bạn trong trạng thái xích, có thể bỏ đi 1 lá của những người trong trạng thái xích.",
	...
	["baoling"] = "Bạo Lăng",
	[":baoling"] = "Chủ tướng kỹ, Tỏa định kỹ, khi kết thúc giai đoạn hành động, nếu đã mở tướng này và có phó tướng, loại bỏ phó tướng, sau đó tăng giới hạn máu thêm 3, hồi 3 máu, nhận kỹ năng \"Băng Hoại\"",
	["benghuai"] = "Băng Hoại",
	...
	["fengshi"] = "Phong Thỉ",
	[":fengshi"] = "Trận pháp kỹ: Trong trạng thái Vây Công, sau khi bạn hoặc người vây công sử dụng lá [Sát] xác định từng mục tiêu bị vây công, mục tiêu bỏ đi 1 lá trong vùng trang bị.",
