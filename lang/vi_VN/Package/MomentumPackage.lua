...
return {
	...
	["chuanxin"] = "Xuyên Tâm",
	[":chuanxin"] = "Giai đoạn ra bài của bạn, khi bạn gây sát thương cho mục tiêu của [Sát] hoặc [Quyết Đấu], nếu họ có thế lực xác định khác với bạn (bạn có thể mở tướng này để xác định thế lực), nếu mục tiêu có Phó tướng, bạn có thể chặn sát thương này, lệnh mục tiêu chọn 1 mục:\n1. Họ bỏ toàn bộ bài trong vùng Trang Bị (ít nhất 1 lá) và mất 1 máu.\n2. Họ loại bỏ Phó tướng.",
