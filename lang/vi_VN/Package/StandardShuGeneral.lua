...
return {
	...
	["liubei"] = "Lưu Bị",
	["rende"] = "Nhân Đức",
	[":rende"] = "Giai đoạn ra bài chủ động: Bạn có thể đem tùy ý lượng bài trên tay giao cho 1 người khác chưa nhận bài từ kỹ năng này trong giai đoạn này;\n▷ Nếu đây là lần đầu tổng số lá bạn giao bằng kỹ năng này trong giai đoạn này ≥ 2, bạn có thể xem như sử dụng 1 lá cơ bản;\n ▷ Nếu bạn sử dụng [Sát] bởi kỹ năng này, [Sát] này được tính giới hạn số lần trong giai đoạn ra bài.",
	...
	["guanyu"] = "Quan Vũ",
	["wusheng"] = "Võ Thánh",
	[":wusheng"] = "• Bạn có thể chuyển hóa sử dụng/đánh ra 1 lá Đỏ -> [Sát].\n• Lá [Sát] RÔ do bạn sử dụng không giới hạn khoảng cách.",
	...
	["pangtong"] = "Bàng Thống",
	["lianhuan"] = "Liên Hoàn",
	[":lianhuan"] = "Giai đoạn ra bài chủ động:\n**: Bạn có thể chuyển hóa sử dụng lá TÉP trên tay -> [Thiết Tác Liên Hoàn].\n** Bạn có thể Tái chế lá TÉP trên tay.",
	["niepan"] = "Niết Bàn",
