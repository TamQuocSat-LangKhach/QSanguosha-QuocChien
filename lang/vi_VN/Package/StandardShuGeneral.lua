...
return {
	...
	["liubei"] = "Lưu Bị",
	["rende"] = "Nhân Đức",
	[":rende"] = "Giai đoạn ra bài, bạn có thể đem tùy ý lượng bài trên tay giao cho 1 người khác chưa nhận bài từ kỹ năng này trong giai đoạn này; nếu làm vậy, khi lần đầu tổng số lá bài bạn giao bằng kỹ năng này trong giai đoạn này ≥ 2, bạn có thể xem như sử dụng 1 lá cơ bản.",
	...
	["guanxing"] = "Quan Tinh",
	[":guanxing"] = "Khi bắt đầu giai đoạn chuẩn bị, bạn có thể xem X lá bài trên đầu chồng bài rút (X là số người chơi còn sống, tối đa 5), sau đó sắp xếp tùy ý những lá này lên đầu hoặc đáy chồng bài rút.",
	["kongcheng"] = "Không Thành",
	[":kongcheng"] = "Tỏa định kỹ: Nếu bạn không có bài trên tay:\n• Khi bạn là mục tiêu của lá [Sát] hoặc [Quyết Đấu], hủy bỏ mục tiêu đối với bạn.\n• Ngoài lượt của bạn, khi bạn nhận được bài do người khác giao cho, đặt những lá bài này lên trên Tướng này, gọi là [Cầm]; khi bắt đầu giai đoạn rút bài, bạn thu lấy tất cả lá [Cầm].",
	...
	["zhaoyun"] = "Triệu Vân",
	["longdan"] = "Long Đảm",
	[":longdan"] = "\n• Bạn có thể chuyển hóa sử dụng/đánh ra [Thiểm] thành [Sát], nếu như [Sát] này bị triệt tiêu bởi [Thiểm] của mục tiêu, bạn có thể gây 1 sát thương cho 1 người ngoại trừ mục tiêu.\n• Bạn có thể chuyển hóa sử dụng/đánh ra [Sát] thành [Thiểm], nếu như [Thiểm] này triệt tiêu [Sát] của 1 người, bạn có thể hồi 1 máu cho 1 người khác ngoại trừ người sử dụng [Sát].",
	...
	["liushan"] = "Lưu Thiện",
	["xiangle"] = "Hưởng Lạc",
	[":xiangle"] = "Tỏa định kỹ: Sau khi bạn trở thành mục tiêu của [Sát], người sử dụng [Sát] chọn bỏ 1 lá cơ bản hoặc lệnh [Sát] đó không có hiệu quả với bạn.",
	["@xiangle-discard"] = "%src đã phát động [Hưởng Lạc], hãy bỏ thêm 1 lá cơ bản nếu không lá [Sát] sẽ vô hiệu.",
	["fangquan"] = "Ủy Quyền",
	[":fangquan"] = "Khi tiến vào giai đoạn ra bài, bạn có thể bỏ qua giai đoạn này; nếu làm vậy, khi kết thúc lượt này, bạn có thể bỏ 1 lá bài trên tay, lệnh 1 người có 1 lượt sau lượt này.",
