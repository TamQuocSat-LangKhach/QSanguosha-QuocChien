return {
	...
	["qingshi"] = "Khuynh Thế",
	[":qingshi"] = "Hai lần trong lượt của mỗi người, sau khi bạn xác định người khác làm mục tiêu của [Sát]/công cụ, nếu lá này là lá thứ X bạn sử dụng trong lượt này, bạn có thể gây 1 sát thương cho 1 người khác là mục tiêu của lá này (X là số lá trên tay bạn).",
	...
	[":quanjian"] = "Một lần trong giai đoạn ra bài, bạn có thể yêu cầu 1 người khác có cùng thế lực với bạn chấp hành [Quân Lệnh];\n▶ Nếu họ không chấp hành, khi họ tính toán sát thương kế tiếp phải nhận trong lượt này, sát thương này +1.",
	["tujue"] = "Đồ Tuyệt",
    ...
    ["yaner"] = "Yễn Nhĩ",
    [":yaner"] = "Một lần trong giai đoạn ra bài của người khác có cùng thế lực với bạn, sau khi họ mất đi lá cuối cùng trên tay, bạn có thể lệnh bạn và họ rút 1 lá.",
